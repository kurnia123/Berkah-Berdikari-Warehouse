...
<head>
    ...
    <title>Tambah Produk - Consonant</title>
                ...
                <ul class="nav text-light flex-column" id="accordionSidebar">
                    ...
                    <li class="nav-item accordion-item">
                        ...
                        <ul id="collapseTransaksi" class="accordion-collapse collapse" aria-labelledby="headingTransaksi" data-bs-parent="#accordion-sidenav">
                            <li><a class="nav-link active" href="./barang-tambah.php">Barang Masuk</a></li>
                                    ...
                                    <div class="card shadow mb-3">
                                        <div class="card-body">
                                            <form method="POST" autocomplete="on">
                                                ...
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="last_name"><strong>Stok</strong></label><input class="form-control" type="number" placeholder="Sisa Stok" name="projumlah" required></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="email"><strong>Nama Supplier</strong></label><input class="form-control" type="text" placeholder="Nama Supplier" name="prosupplier" required></div>
                                                    </div>
                                                </div>
